...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mirrors the framework's lang/en/validation.php keys (Laravel 13).
    |
    */
    ...
    'ascii' => 'O campo :attribute deve conter apenas caracteres alfanuméricos e símbolos simples.',
    ...
    */
    ...
    'custom' => [
        'phone' => ['regex' => 'O telefone deve ter DDD e número, só dígitos (10 a 13).'],
        'whatsapp' => ['regex' => 'O WhatsApp deve ter DDD e número, só dígitos (10 a 13).'],
        'document' => ['regex' => 'O CPF/CNPJ deve ter 11 ou 14 dígitos.'],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'accent_color_hover' => 'cor de destaque (hover)',
        'accent_color_soft' => 'cor de destaque (suave)',
        'active' => 'ativo',
        'address' => 'endereço',
        ...
        'catalog_visible' => 'visível no catálogo',
        'category' => 'categoria',
        'cost_cents' => 'custo',
        'cover' => 'capa',
        ...
        'name' => 'nome',
        'notes' => 'observações',
        'notice_active' => 'aviso ativo',
        'notice_expires_on' => 'validade do aviso',
        'notice_text' => 'texto do aviso',
        'notice_type' => 'tipo do aviso',
        'on_primary_color' => 'cor do texto sobre a cor principal',
        'original_price_cents' => 'preço original',
        'paid' => 'pago',
        ...
        'product_price_cents' => 'preço do produto',
        'promo_price_cents' => 'preço promocional',
        'quantity' => 'quantidade',
        'reason' => 'motivo',
        'receipt' => 'comprovante',
        'recurring' => 'recorrente',
        'remove_image_ids.*' => 'imagem',
        'slug' => 'endereço (slug)',
        ...
        'variant_id' => 'variação',
        'variants' => 'variações',
        'variants.*.name' => 'nome da variação',
        'variants.*.stock_qty' => 'estoque da variação',
