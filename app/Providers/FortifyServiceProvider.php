...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton(LoginResponse::class, OrganizationLoginResponse::class);
        $this->app->singleton(LogoutResponse::class, OrganizationLogoutResponse::class);
        $this->app->singleton(PasswordResetResponse::class, OrganizationPasswordResetResponse::class);
    }
