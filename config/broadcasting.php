    ...
    */
    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            // Server-to-server publishing can reach the reverb container
            // directly over the docker network (REVERB_INTERNAL_*); the
            // public REVERB_* values are what the browser client uses.
            'options' => [
