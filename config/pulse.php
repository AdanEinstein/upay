...
return [
    ...
    */
    ...
    'path' => env('PULSE_PATH', 'super-admin/pulse'),
    ...
    */
    ...
    /*
     * Pulse's own Authorize middleware checks the "viewPulse" gate against
     * the default (web) guard, which is never the one authenticated here —
     * super admins sign in through a separate "super_admin" guard (see
     * App\Auth\SuperAdminUserProvider). Gate the dashboard on that guard
     * directly instead of relying on Gate::viewPulse.
     */
    'middleware' => [
        'web',
        'auth:super_admin',
